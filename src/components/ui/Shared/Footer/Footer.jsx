...
export default function Footer() {
  return (
    <footer className="relative w-screen left-1/2 right-1/2 -mx-[50vw] bg-white border-t border-gray-200 shadow-t-sm">
      <div className="max-w-7xl mx-auto px-4 py-10 grid gap-6 md:grid-cols-3 text-sm">
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2">
            ...
            <li>
              <Link to="/available-camps" className="hover:underline text-gray-600">
                Available Camps
              </Link>
            </li>
            <li>
              <Link to="/dashboard" className="hover:underline text-gray-600">
                Dashboard
              </Link>
            </li>
            <li>
              <Link to="/join" className="hover:underline text-gray-600">
                Join Us
              </Link>
            </li>
          </ul>
